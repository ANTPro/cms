...
function generate_wysiwyg(textareaID) {
  ...
  var n = textareaID;
	...
	//toolbarWidth = 100;//parseFloat(wysiwygWidth) + 2;
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:100%; height:100%;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
