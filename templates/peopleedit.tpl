	<table class="text" width="100%" cellspacing="0" cellpadding="5">
		<form method="POST">
			...
			<tr>
				<td>Отчество:</td>
				<td>
					<input name="patronymic" type="text" value="[PROFILE_PATRONYMIC]" style="width:100%;">
				</td>
			</tr>
			<tr>
				<td>Пол:</td>
			...
			<tr>
				<td>Тип:</td>
				<td>
					<select name="id_userprivs" style="width:100%;">
						[USERPRIVS]
					</select>
				</td>
			</tr>
			...
			<tr>
				<td>Статус:</td>
				<td>
					<input name="status" type="text" value="[PROFILE_STATUS]" style="width:100%;">
				</td>
			</tr>
			<tr>
